...
name: oh-fact-check
description: >
  Use to fact-check a Ohio court filing before filing. Runs citation verification, internal consistency, packet consistency, and sworn-vs.-argued consistency passes.
version: 0.1.0
---
