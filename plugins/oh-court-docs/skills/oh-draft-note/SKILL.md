...
name: oh-draft-note
description: >
  Scaffold the scheduling document that places a motion on the Ohio court's calendar (terminology varies by state — Notice of Hearing, Note for Motion Docket, Notice of Motion, etc.).
version: 0.1.0
---

# Draft a Ohio Notice/Note
