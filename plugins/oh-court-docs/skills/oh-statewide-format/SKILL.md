...
description: >
  Use when the user asks to draft or format a court document for any Ohio court. Triggers include 'draft a pleading', 'format a Ohio document', 'apply Ohio Civ. R. 10 + per-court local rules', 'build a caption'. Covers Ohio Civ. R. 10 + per-court local rules page formatting, caption requirements, document titles, and citation format per the Ohio Manual of Citations.
version: 0.1.0
---

# Ohio Statewide Format
