...
description: >
  Subject-matter bundle for Ohio consumer-debt defense: FDCPA, Regulation F, the Ohio consumer-protection statute, the Ohio collection-agency regime (if any), chain of title, and synthetic example filings.
version: 0.1.0
---

# Ohio Consumer-Debt Defense
