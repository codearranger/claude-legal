...
description: >
  Matter-neutral reference catalog for Ohio civil practice: Ohio Civ. R. civil rules, Ohio Evid. R. evidence rules, statute citations, fees-and-costs, local rules, key cases, and the canonical online-sources catalog.
version: 0.1.0
---
