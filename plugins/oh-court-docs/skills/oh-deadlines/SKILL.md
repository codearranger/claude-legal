...
name: oh-deadlines
description: >
  Use when the user asks about timing or deadlines in a Ohio civil case. Computes calendar-day and court-day deadlines using state holidays and the state's rules of time computation.
version: 0.1.0
---
