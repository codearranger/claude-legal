...
example filings for a California debt-buyer-defense fact
pattern:

- **example-answer.md** — Answer with affirmative defenses
  (including FDBPA, CDCLA, SOL, chain-of-title) and
  counterclaims (FDCPA, Rosenthal Act, UCL)
- **example-declaration.md** — Declaration of debtor in
  opposition to summary judgment per CCP § 2015.5
- **example-motion-to-compel.md** — Motion to compel further
  responses to RFPs; separate statement reference per CRC
  rule 3.1345; 45-day timeliness; meet-and-confer declaration
- **example-meet-and-confer.md** — California M&C letter
  per CCP § 2031.310(b)(2)
- **example-proposed-order.md** — Proposed order granting
  motion to compel
- **example-certificate-of-service.md** — Proof of Service
  (California POS-030 / POS-040 narrative form)

The examples are **fictional** but procedurally complete.
They illustrate California court form practice applied to
...
- `references/examples/` — synthetic example filings
