...
- **example-answer.md** — Answer with affirmative defenses
  and counterclaims
- **example-declaration.md** — Declaration in support of a
  motion to compel
- **example-motion-to-compel.md** — Motion to compel
  chain-of-title documents
- **example-meet-and-confer.md** — Meet-and-confer
  correspondence
- **example-proposed-order.md** — Proposed order on motion
  to compel
- **example-certificate-of-service.md** — Certificate of
  Service
