...
description: >
  ...
  RFP/RFA banks, and synthetic example filings.
version: 0.1.0
---
...
| # | Pattern | First move |
|---|---|---|
| **1** | Stale credit-card debt (charge-off > 3 yrs before filing) | CPLR 3211(a)(5) motion to dismiss (SOL) |
...
- `references/fdcpa.md` — NY-specific framing for the FDCPA
  (verbatim text in
  `ny-law-references/references/federal-debt-laws/FDCPA.md`
  symlinked to the shared plugin)
