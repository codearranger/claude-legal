...
description: >
  ...
  chain-of-title doctrine, discovery targeting the elements a debt
  buyer must prove, and synthetic example filings. Composes with
...
discovery banks, case catalog, and example filings that apply when
the matter is debt collection — whether the plaintiff is a debt
buyer, a collection law firm, or the original creditor.
...
The pattern match drives (a) MTD vs. answer, (b) which affirmative
defenses to plead, (c) which counterclaims to plead, and (d) what
to serve in first-wave discovery.
...
`references/examples/` contains six synthetic sample filings (Acme
Portfolio Recovery, LLC v. Jane Q. Public — fictional). All are
debt-buyer scenarios. Use them as structural and substantive
templates; do not copy names, dates, or facts.
