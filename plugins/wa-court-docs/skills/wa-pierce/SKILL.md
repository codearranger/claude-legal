...
description: >
  ...
  Actions (MAR) for cases ≤ $100,000** under RCW 7.06.
  Coverage includes the **Pierce County electronic filing
  system (LINX / Pierce County e-Filing)**, the
  **standing case-management order** at PCLR 16, the
  family-law commissioner system, and Pierce County
  General Order on remote appearances. Triggers include
  "Pierce County Superior Court", "Tacoma Superior
  Court", "PCLR", "Pierce County local rules", "Pierce
  County e-filing", "Pierce County family law", "Pierce
  MAR".
version: 0.1.0
---
...
> **NOT LEGAL ADVICE.** Verify Pierce County Local Rules
> (PCLR) and current standing orders before filing.
...
- Response due 6 court days before
- Reply due 3 court days before
- Working copies to judge or commissioner
...
### Pierce County Family Law Local Rules

Separate set governing family-law cases — temporary
orders, parenting evaluators, family-court commissioner
practice.

## E-filing — LINX (Pierce County E-Filing System)
...
- Cases ≤ **$100,000** in damages are referred to
  arbitration after answer + initial discovery
- Arbitrator selected from the Pierce County roster
- Award filed; **trial de novo** available on demand
  within 20 days (MAR 7)
- Sanctions if trial de novo result is no better than
  arbitration award (MAR 7.3)

## Commissioners

Pierce County uses commissioners for:
...
**Revision motion** within 10 days under RCW 2.24.050 to
challenge commissioner ruling.
