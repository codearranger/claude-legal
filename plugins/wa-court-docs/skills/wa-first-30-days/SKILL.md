...
The pattern match drives (a) whether to move to dismiss or
answer, (b) which affirmative defenses to plead, (c) which
counterclaims to plead, and (d) what to serve in initial
discovery.
