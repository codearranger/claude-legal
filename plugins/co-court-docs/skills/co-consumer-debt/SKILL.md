...
description: >
  ...
  UCC Article 9 (C.R.S. art. 9 of title 4), the SOL framework, and
  synthetic example filings for debt-buyer defense.
version: 0.1.0
---
...
## Synthetic example filings

The `references/examples/` directory contains six fully drafted
synthetic example filings (using fabricated party names — DO NOT use
in a real case):

1. `example-answer.md` — Answer + Affirmative Defenses + Counterclaim
2. `example-declaration.md` — Defendant's Declaration in support of
   motion to compel
3. `example-motion-to-compel.md` — Motion to Compel under C.R.C.P.
   37(a)
4. `example-meet-and-confer.md` — M&C letter
5. `example-proposed-order.md` — Proposed Order on the Motion to
   Compel
6. `example-certificate-of-service.md` — standalone Certificate of
   Service
...
- `references/examples/` — six synthetic example filings
