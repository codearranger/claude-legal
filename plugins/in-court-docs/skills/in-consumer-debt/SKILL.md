...
description: >
  ...
  RFP / RFA / interrogatory banks, and synthetic example
  filings. Trigger phrases: "FDCPA Indiana", "DCSA Indiana",
...
- `references/dcsa-demand-letter.md` — pre-suit 30-day cure
  demand letter
- `references/examples/` — synthetic example filings (caption
  + body) for the 5 fact patterns
