...
- **`ny-court-docs`** — **New York.** Applies 22 NYCRR § 202.5 paper format and 22 NYCRR § 202.5-b NYSCEF electronic-filing format with the New York caption ("-against-" party separator, Index Number, assigned Justice + Part); covers **five flagship Supreme Court venues each as its own skill** — New York County (1st JD / Manhattan / 60 Centre Street with the $500k-threshold Commercial Division under 22 NYCRR § 202.70), Kings County (2nd JD / Brooklyn / 360 Adams Street with the high-volume CPLR 3408 foreclosure conference part), Bronx County (12th JD / 851 Grand Concourse), Nassau County (10th JD / Mineola with a $200k-threshold Commercial Division), and Queens County (11th JD / Jamaica) — plus a long-tail roll-up covering Suffolk / Westchester / Erie / Monroe / Onondaga / Richmond Supreme Courts, the four NYC Civil Court borough branches under the Civil Court Act ($50k cap, the largest consumer-debt forum in the state), Nassau and Suffolk District Courts, upstate City Courts, and Town & Village Justice Courts. Pro se under the post-2023 CPLR 2106 universal affirmation under penalty of perjury (L 2023, ch 559 ended the notary-bottleneck for pro se filers). **Two subject-matter bundles** ship in the initial release: `ny-consumer-debt` (FDCPA, Reg F, **2022 Consumer Credit Fairness Act** including the 3-year SOL on consumer-credit at CPLR 213(a), heightened pleading at CPLR 3015(e), heightened default-judgment evidence at 22 NYCRR § 202.27-a, additional notice mailing at CPLR 308(six); N.Y. GBL § 600 collection-agency licensing; N.Y. GBL §§ 349 / 350 deceptive acts; CPLR 4544 small-print contracts; chain of title under N.Y. UCC Article 9 with CPLR 4518 business-records foundation per *Bank of NY Mellon v. Gordon*, 171 AD3d 197 (2d Dept 2019)) and `ny-landlord-tenant` (RPAPL Article 7 summary proceedings, **2019 HSTPA** reforms including the 1-month security-deposit cap and bilateral attorney's-fee shifting, the **2024 Good Cause Eviction Law** at RPL Article 6-A, rent regulation regimes, RPL § 235-b warranty of habitability, NYC right-to-counsel under Local Law 136 of 2017, ERAP stays). **25 SKILL.md files** total — the largest state plugin in the marketplace because of the 5 flagship court skills + 2 subject bundles. NY procedural quirks worth flagging: (1) **CPLR 2103(b)(2) 5-day mail-service rule** (longer than the federal/WA/OR 3-day rule); (2) **verified-vs-unverified pleadings** under CPLR 3020 with the tactical forced-verification trigger when account-stated is alleged; (3) **CPLR 2106 universal affirmation** (post-2023) eliminating notary for pro se filers; (4) **Individual Assignment System** under 22 NYCRR § 202.3 where a single Justice owns the case through judgment with their own Part Rules; (5) **22 NYCRR § 202.48 settle-order procedure** with a jurisdictional 60-day clock under *Funk v. Barry*; (6) **20-year SOL on money judgments** at CPLR 211(b) — the longest in the U.S. NYSCEF mandatory e-filing in most counties since 2014-2022 rollouts.
...
| `ny-court-docs` | CPLR + GBL/GOL/RPL/RPAPL/UCC stubs (pull scripts TBD) | 22 NYCRR Parts 202/208/210/212 stubs | shared |
...
│   └── ny-court-docs/                # New York (25 skills — 5 flagship courts + 2 subject bundles)
