...
The two shared plugins bundle two free remote MCP servers (declared in each plugin's `.mcp.json`), so installing any state plugin wires them up automatically:

| Server | URL | What it provides | Auth |
|---|---|---|---|
