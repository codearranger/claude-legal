...
plugins/claude-legal-immigration-laws/  # SHARED immigration-law reference plugin (references-only; no skills yet)
  ...
  references/foreign-affairs-manual/    # FAM pointer stubs (fam.state.gov bot-gated); verbatim when reachable
...
scripts/
  ...
  pull_fam.py                       # fam.state.gov (bot-gated 503) → foreign-affairs-manual/ (pointer stubs; verbatim when reachable)
```
