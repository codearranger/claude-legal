...
The `claude-legal` **marketplace** — a Claude Code / Cowork marketplace of court-document plugins organized one plugin per state, plus two shared federal reference plugins (a debt/consumer-finance corpus + a nationwide FCRA consumer credit-report-rights skills layer, and an immigration-law corpus). It ships **thirteen plugins total — eleven state plugins + two shared federal reference plugins**:
...
- **`ar-court-docs`** — Arkansas (no single statewide page/margin/font rule — form of pleadings is governed by **Ark. R. Civ. P. 10** (caption + numbered paragraphs + Rule 10(c) written instruments) and **Rule 11** (signature with the attorney's Arkansas Bar Number / Pro Se), with **Administrative Order No. 19** governing redaction of confidential information + a certificate of compliance and **Administrative Order No. 21** governing **eFlex** e-filing; typography/page limits come from each court's local rules — the same "no statewide format rule" posture as Tennessee). Arkansas unified its trial courts under **Amendment 80** (effective July 1, 2001), merging the former Chancery (equity), Probate, and Circuit (law) courts into a single **Circuit Court** of general jurisdiction organized into five administrative divisions (criminal, civil, probate, domestic relations, juvenile) across **28 judicial circuits / 75 counties**; below it sits the limited-jurisdiction **District Court** (civil cap + small-claims division + unlawful-detainer eviction — the high-volume consumer-debt + eviction forum, with a 30-day **de novo** appeal to Circuit Court). Ships dedicated venue skills for the three largest Circuit Court counties — **Pulaski** (Little Rock, 6th Circuit — the state's largest court; eFlex/Contexte), **Benton** (Bentonville, 19th-W), **Washington** (Fayetteville/Springdale, 4th) — plus an `ar-district-courts` skill, an `ar-county-courts` roll-up, and an `ar-family-court` skill (Arkansas hears family matters in the **Domestic Relations Division of Circuit Court** — no separate family court — with the Juvenile Division for paternity / dependency-neglect / FINS / TPR under the Arkansas Juvenile Code at Title 9 ch. 27). Citation is the Arkansas **medium-neutral / public-domain** form (`2015 Ark. 100` / `2015 Ark. App. 200`) under **Ark. Sup. Ct. R. 5-2**. ARKANSAS QUIRKS flagged across the skills: Arkansas is a **fact-pleading** jurisdiction (Ark. R. Civ. P. 8 requires a statement of *facts*, not notice pleading); the **Rule 60(a) 90-day window** to modify/vacate a judgment vs. the narrower Rule 60(c) grounds after 90 days; the *Wallace v. Broyles* / *Flentje* "meet proof with proof" summary-judgment standard. **Six subject-matter bundles**: `ar-consumer-debt` (FDCPA + Reg F + the **Arkansas Deceptive Trade Practices Act (ADTPA)** at Ark. Code Ann. § 4-88-101 with the **Act 986 of 2017** private-action narrowing (actual financial loss + reliance; class-action limits) + collection-agency licensing under the **Arkansas State Board of Collection Agencies** at § 17-24-101 with an unlicensed-collector capacity challenge + chain of title under Arkansas UCC Article 9 + the **5-year written / 3-year open-account SOL split** at § 16-56-111 / § 16-56-105 + the fact-pleading defense angle; District Court forum; 5-pattern triage); `ar-family-law` (Title 9 — divorce grounds at § 9-12-301 incl. the **18-month-separation no-fault ground** + the distinctive Arkansas **corroboration-of-grounds** requirement + 60-day/3-month residency at § 9-12-307 + **covenant marriage** at § 9-11-801 (Arkansas is one of three covenant-marriage states) + **equitable distribution** with the one-half presumption at § 9-12-315 + **income-shares** child support under **Administrative Order No. 10** (eff. July 1, 2020) + the **Act 604 of 2021 rebuttable joint-custody presumption** rebutted only by clear-and-convincing evidence at § 9-13-101 + discretionary alimony at § 9-12-312 + no common-law marriage + UCCJEA at § 9-19-101 / UIFSA at § 9-17-101 + the Domestic Abuse Act at § 9-15-101); `ar-landlord-tenant` (the notorious **criminal failure-to-vacate** statute at § 18-16-101 + civil unlawful detainer at § 18-60-301 + the **Arkansas Residential Landlord-Tenant Act of 2007** at § 18-17-101 + the **Act 1052 of 2021 implied-habitability** minimum standards at § 18-17-501 — Arkansas was the **last state in the nation** to adopt any implied habitability, with a notice→30-day-cure→terminate-and-recover-deposit remedy and no rent-withholding/repair-and-deduct + security deposits at § 18-16-301 with the small-landlord exemption; District Court forum); `ar-personal-injury` (**modified comparative fault** with the **"less than" 49% bar** at § 16-64-122 + **several liability** under the **Civil Justice Reform Act of 2003** at § 16-55-201 with the nonparty-fault provision struck in *Johnson v. Rockwell Automation*, 2009 Ark. 241 and the punitive cap struck in *Bayer CropScience LP v. Schafer*, 2011 Ark. 518 + **no damages caps** under **Ark. Const. art. 5, § 32** + the **Medical Malpractice Act** at § 16-114-201 (2-year SOL at § 16-114-203) with the **affidavit-of-merit requirement held unconstitutional** in *Summerville v. Thrower*, 2007 Ark. 366 + **near-absolute state sovereign immunity** under **Ark. Const. art. 5, § 20** reaffirmed in *Bd. of Trustees of Univ. of Ark. v. Andrews*, 2018 Ark. 12 routing claims to the **Arkansas State Claims Commission** at § 19-10-201, with political-subdivision immunity at § 21-9-301 + wrongful death at § 16-62-102); `ar-employment` (the **Arkansas Civil Rights Act of 1993** at § 16-123-101 — 9+ employees, 1-year SOL, no administrative-exhaustion prerequisite, individual liability + the **Arkansas Minimum Wage Act** at § 11-4-201 — 4+ employees + at-will with the *Sterling Drug v. Oxford* public-policy exception + the **Arkansas Whistle-Blower Act** at § 21-1-601 + non-compete reformation/blue-penciling under **Act 921 of 2015** at § 4-75-101 + workers'-comp exclusive remedy at § 11-9-101 + right-to-work under **Ark. Const. Amendment 34**); and `ar-commercial-disputes` (**no dedicated statewide business court** — commercial cases sit in the civil division of Circuit Court + UCC at Title 4 + the **Arkansas Trade Secrets Act** at § 4-75-601 with exemplary damages up to 2x + the ADTPA B2B reliance/actual-loss element + the **Arkansas Uniform LLC Act** at § 4-38-101 (Act 1041 of 2021, replacing the prior Small Business Entity Tax Pass Through Act at § 4-32-101) + the **Arkansas Business Corporation Act of 1987** at § 4-27-101 + the **Arkansas Uniform Fraudulent Transfer Act** at § 4-59-201 (still UFTA, not UVTA) + the **Arkansas Uniform Arbitration Act** at § 16-108-201 with FAA-preemption practice + Rule 9(b) fraud-with-particularity). Follows the thin-skill architecture — procedural frameworks point at the references corpus for current statutory text, dollar thresholds, and day counts. **29 SKILL.md files**.

All eleven state plugins are architected identically: matter-neutral civil-procedure skills plus subject-matter bundles (consumer-debt + family-law in each state, with additional subject bundles where the state's civil practice justifies them). The structure leaves clean slots for plugins covering additional states.
...
## Skills index — Federal immigration self-help (`claude-legal-immigration-laws`, 11 skills)
...
## Skills index — Washington (`wa-court-docs`, 32 skills)
...
## Skills index — Arkansas (`ar-court-docs`, 29 skills)

| Skill | Role |
|---|---|
| `ar-statewide-format` | Canonical layout home — Ark. R. Civ. P. 10 caption + numbered paragraphs + Rule 10(c) written instruments, Rule 11 signature (Ark. Bar No. / Pro Se), Administrative Order No. 19 redaction + certificate of compliance, Administrative Order No. 21 eFlex e-filing, medium-neutral citation (Ark. Sup. Ct. R. 5-2); **no statewide page/margin/font rule** — typography defers to local rules |
| `ar-pulaski` | Pulaski County Circuit Court (Little Rock) — 6th Judicial Circuit; the state's largest court; five-division structure; eFlex/Contexte e-filing |
| `ar-benton` | Benton County Circuit Court (Bentonville) — 19th Judicial Circuit West |
| `ar-washington` | Washington County Circuit Court (Fayetteville / Springdale) — 4th Judicial Circuit |
| `ar-district-courts` | Limited-jurisdiction District Courts (civil cap + small-claims division + unlawful-detainer eviction); State vs. Local District Courts; the dominant consumer-debt + eviction forum; 30-day de novo appeal to Circuit Court |
| `ar-county-courts` | Roll-up for the other populous counties' Circuit Courts; the 28-judicial-circuit / 75-county Amendment 80 structure |
| `ar-pro-se` | Pro-se drafting framework; self-represented signature (no bar number); service + certificate under Ark. R. Civ. P. 5; Administrative Order No. 19 self-redaction; arcourts.gov self-help |
| `ar-law-references` | Civil rules, evidence, fees (§ 16-22-308), citation, key cases, online sources, legal-data-apis — **canonical reference corpora live here** (`court-rules/`, `ar-statutes-debt/`, federal symlinks) |
| `ar-discovery` | Ark. R. Civ. P. 26–37; interrogatories ARE allowed (Rule 33, presumptive cap); RFPs (34), RFAs (36), depositions (30/31), motion to compel (37); good-faith conferral |
| `ar-hearings` | Oral argument, motion practice, remote-appearance practice (local-rule-dependent), etiquette |
| `ar-post-judgment` | Rule 59 (new trial, 10-day) + Rule 60 (the 90-day Rule 60(a) window vs. narrower Rule 60(c)); execution/garnishment + constitutional exemptions; 10-year judgment life + scire facias revival |
| `ar-first-30-days` | 30-day answer (Rule 12(a)); Rule 12(b) triage incl. 12(b)(6); **flags Arkansas fact-pleading** (facts, not conclusions); affirmative defenses (Rule 8); counterclaims (Rule 13); default (Rule 55) |
| `ar-fact-check` | Citation verification (medium-neutral 2015 Ark. 100 / 2015 Ark. App. 200; Ark. Code Ann.; Ark. R. Civ. P./Evid.), internal/packet/sworn-vs-argued consistency |
| `ar-deadlines` | Ark. R. Civ. P. 6 computation + Rule 6(d) 3-day mail add-on; Ark. Code Ann. § 1-5-101 holidays (Daisy Gatson Bates Day + Christmas Eve); named-rule catalog via `case-calendar.py` |
| `ar-draft-motion` / `-declaration` / `-note` / `-order` | Scaffolders; the *Wallace v. Broyles* "meet proof with proof" SJ standard lives in `-motion`; `-declaration` defaults to a notarized affidavit; `-note` is the **Notice of Hearing** |
| `ar-quality-check` | Pre-filing two-pass format + content QC (Ark. R. Civ. P. 10/11 caption + signature; Administrative Order No. 19 redaction; WARN where typography is a local-rule matter) |
| `ar-schedule-hearing` | Coordinate-with-the-division-then-notice; per-county practice; District Court return-date practice |
| `ar-file-packet` | Assemble + file; eFlex (Administrative Order No. 21) e-filing assembly; Administrative Order No. 19 redaction + certificate of compliance; preflight |
| `ar-submit-order` | Post-hearing proposed-order transmittal; prevailing party prepares + circulates "approved as to form"; entry of order |
| `ar-family-court` | Venue: the Domestic Relations Division of Circuit Court (no separate family court); the Juvenile Division for paternity / dependency-neglect / FINS / TPR (Arkansas Juvenile Code, Title 9 ch. 27); residency/venue; eFlex; ad litem; mediation |
| `ar-consumer-debt` | Subject bundle: FDCPA + Reg F + ADTPA (§ 4-88-101; Act 986 of 2017 private-action narrowing) + collection-agency licensing (§ 17-24-101; capacity challenge) + chain of title + SOL split (§ 16-56-111 5yr / § 16-56-105 3yr) + Arkansas fact-pleading; District Court forum + de novo-appeal strategy |
| `ar-family-law` | Subject bundle: Title 9 — 18-month-separation no-fault ground + corroboration-of-grounds requirement (§ 9-12-301/-307) + covenant marriage (§ 9-11-801) + equitable distribution with the one-half presumption (§ 9-12-315) + income-shares child support (Administrative Order No. 10, eff. 2020) + the Act 604 (2021) joint-custody presumption (§ 9-13-101) + alimony (§ 9-12-312) + UCCJEA/UIFSA + Domestic Abuse Act (§ 9-15-101) |
| `ar-landlord-tenant` | Subject bundle: criminal failure-to-vacate (§ 18-16-101) + civil unlawful detainer (§ 18-60-301) + RLTA of 2007 (§ 18-17-101) + the Act 1052 of 2021 implied-habitability minimum standards (§ 18-17-501 — last state to adopt) + security deposits (§ 18-16-301, small-landlord exemption); District Court |
| `ar-personal-injury` | Subject bundle: modified comparative fault "less than" 49% bar (§ 16-64-122) + several liability (Civil Justice Reform Act of 2003, § 16-55-201) with *Johnson v. Rockwell* / *Bayer CropScience v. Schafer* struck provisions + no damages caps (Ark. Const. art. 5 § 32) + Medical Malpractice Act (§ 16-114-203; affidavit-of-merit struck, *Summerville*) + sovereign immunity (art. 5 § 20 / *Andrews* → State Claims Commission) + § 21-9-301 municipal immunity + wrongful death (§ 16-62-102) |
| `ar-employment` | Subject bundle: Arkansas Civil Rights Act of 1993 (§ 16-123-101; 9+ employees, 1-yr SOL, individual liability) + Minimum Wage Act (§ 11-4-201; 4+ employees) + at-will + *Sterling Drug* public-policy exception + Whistle-Blower Act (§ 21-1-601) + non-compete reformation (§ 4-75-101, Act 921 of 2015) + workers'-comp exclusive remedy (§ 11-9-101) + right-to-work (Amendment 34) |
| `ar-commercial-disputes` | Subject bundle: no dedicated business court (Circuit Court civil division) + UCC (Title 4) + Arkansas Trade Secrets Act (§ 4-75-601, up to 2x exemplary) + ADTPA B2B reliance/actual-loss element + Arkansas Uniform LLC Act (§ 4-38-101, Act 1041 of 2021) + Business Corporation Act of 1987 (§ 4-27-101) + Arkansas UFTA (§ 4-59-201) + Uniform Arbitration Act (§ 16-108-201) + Rule 9(b) fraud particularity |
...
## Reference corpora — Arkansas (`ar-law-references/references/`)
...
- **`federal-bankruptcy/`** *(symlink)* — points into `claude-legal-federal-laws/references/federal-bankruptcy/`.
- **`ucc-model/`** *(symlink)* — points into `claude-legal-federal-laws/references/ucc-model/`.
- **`ar-statutes-debt/`** — **Arkansas Code Annotated** civil + family + consumer chapters pulled by `scripts/pull_arkansas_statutes.py` from the **Justia mirror** (`law.justia.com/codes/arkansas/`). The section text is public domain (LexisNexis publishes the official *annotated* code under copyright); Arkansas nests Title → Subtitle → Chapter → Subchapter → Section, so the puller **discovers** section URLs by link-walking (subtitle/subchapter-agnostic) rather than constructing them. Justia sits behind Cloudflare bot-fight mode, so the puller uses **curl_cffi** with Chrome TLS impersonation when available and falls back to **well-formed pointer stubs** on block; the `_file_is_stub` guard preserves committed verbatim content. The directory name retains the legacy `debt` slug for path stability; scope covers the full civil + family + consumer surface (Titles 1, 4, 9, 11, 16, 17, 18, 19, 21).
- Curated reference files: `civil-rules.md`, `evidence-rules.md`, `fees-and-costs.md`, `citation-format.md`, `key-cases.md`, `online-sources.md`, `legal-data-apis.md`.
...
# Arkansas scripts
python3 plugins/ar-court-docs/scripts/format-check.py <file>   # Ark. R. Civ. P. 10/11 + common-practice check (WARN where typography is local-rule)
python3 plugins/ar-court-docs/scripts/case-calendar.py ...     # Ark. R. Civ. P. 6 deadline arithmetic with Ark. Code Ann. § 1-5-101 holidays (incl. Daisy Gatson Bates Day + Christmas Eve)
python3 plugins/ar-court-docs/scripts/case-calendar.py --rules # List Arkansas named deadline rules
```
...
plugins/claude-legal-immigration-laws/  # SHARED immigration-law plugin: reference corpora + an 11-skill venue-independent self-help layer (v0.3.0)
